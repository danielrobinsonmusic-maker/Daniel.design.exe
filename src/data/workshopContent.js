...
export const WORKSHOP_CONTENT = [
    ...
    },
    {
        ...
        caption: "Daniel has written, produced, and recorded several full length albums, as well as scored films projects and video games. This is one of his latest albums: The Birds."
    }
];
